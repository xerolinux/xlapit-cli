...
This repository contains all the source code for XeroCLI, and all the scripts that go with it. For more information and details, please check the included [Wiki](https://github.com/xerolinux/xlapit-cli/wiki). See here how you can [**contribute**](https://github.com/xerolinux/xlapit-cli/wiki/User-Contribution) improving the toolkit which would be highly appreciated.
